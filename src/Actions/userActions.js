...
export const getUser  = id =>  async(dispatch)=>{
    try{
      ...
      const {data} = await axios.get(`https://server-side-files-1.onrender.com/api/v1/admin/user/${id}`);
...
export const deleteUser  = id =>  async(dispatch)=>{
    try{
      ...
      await axios.delete(`https://server-side-files-1.onrender.com/api/v1/admin/user/${id}`);
...
export const updateUser =(id,formData) => async(dispatch)=>{
    try{
        ...
        const config ={
         ...
         await axios.put(`https://server-side-files-1.onrender.com/api/v1/admin/user/${id}`,formData, config);
